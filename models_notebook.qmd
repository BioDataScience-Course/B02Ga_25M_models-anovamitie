...
Toutes ces analyses nous montrent que en effet, la morphologie du juvénile a un effet significatif sur le temps d'attaque des adultes.

Les patterns, quant à eux, semblent être également significatifs sur le temps d'attaque, mais cette conclusion n'est pas correcte pour toutes les analyses : en effet, certains modèles linéaires ou régressions linéaires montrent que cette variable n'est pas significative. Néanmoins, nous pouvons invalider ces modèles étant donné que les conditions pour les réaliser ne sont pas tout à fait correctes.
