...
-	Les effets du Pattern :
*Le pattern « painted » n’a pas d’effet significatif au seuil alpha de 5%.
*L’effet du pattern « painted random » sur le temps d’attaque est significatif au seuil alpha de 5%. Ces proies sont attaquées 186 secondes plus tôt que les « painted ».
*Également le manque de pattern a un effet très significatif au seuil alpha de 5% avec une attaque moyenne 219 secondes plus tôt que celle de référence.
-	Les effets de l’espèce de proie : 
il n’y a pas d’effet significatif de l’espèce de la proie sur le temps d’attaque au seuil alpha de 5%
-	Les effets de l’interaction entre le motif et l’espèce :
L’effet du motif « Painted » sur le temps d’attaque est significativement au seuil alpha de 5% différent selon l’espèce de la proie. Lorsque la proie est peinte et est un kingsnake, elle est attaquée plus vite que dans le cas de référence.
