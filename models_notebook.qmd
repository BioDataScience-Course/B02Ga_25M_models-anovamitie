...
Les données ont été collectées par (Warwick Nash *et al)* et sont en accès libre (sous licence CC BY 4.0 avec le DOI [10.24432/C55C7W](https://doi.org/10.24432/C55C7W))**.** Toutes les informations sur les données, le déroulé des expériences et le dictionnaire des données sont disponibles dans l'article.
...
Mettre que c'est pas pertinent et pourquoi est ce qu'on a tester ça ( genre truc biologique les grand attaque les grands...) \<\<\<\<\<\<\< HEAD

<<<<<<< HEAD
=======
<!--% Ajustez une régression linéaire simple, multiple ou polynomiale par paire d'étudiants dans cette section (donc, deux modèles pour l'équipe de quatre). -->

>>>>>>> fc4ca0f82617e39db5baf30df47b9f63131ebaa0
